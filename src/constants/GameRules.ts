...
export const rulesData: RulesData = [
  ...
  { title: "Combo de Letras", description: "Si el jugador logra encadenar tres letras consecutivas en orden alfabético en su palabra, inflige un daño adicional de 5 puntos." },
  ...
  { title: "Desafío Lingüístico", description: "En cada turno, se asigna una letra como 'letra desafiante'. Si un jugador utiliza esa letra en su palabra, su ataque causa el doble de daño." },
  { title: "Ruleta de Sílabas", description: "Al inicio de cada ronda, se selecciona al azar una sílaba adicional. Si un jugador utiliza esa sílaba en su palabra, obtiene un bono de 10 puntos de vida." },
]
